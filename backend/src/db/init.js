...
async function initializeDatabase() {
  try {
    ...
    if (tableCheck.rows[0].exists) {
      // Delete all non-Lilien products
      ...
      // Add Lilien products if they don't exist
      console.log('Adding Lilien products...');
      await db.query(`
        INSERT INTO products (name, description, price, image_url, category, stock) VALUES
        ('Lilien Premium Super Clumping Cat Litter 6L', 'Premium quality super clumping cat litter. Superior odor control, low dust formula, easy to scoop. Keeps your cat''s litter box fresh and clean.', 7.90, '/products/litter-6l.jpg', 'Litter', 200),
