...
const animalCategories = [
  ...
  { name: 'Dogs', image: 'https://as1.ftcdn.net/v2/jpg/00/88/34/58/1000_F_88345863_tdpJPVC3pY1L5US7skyHJVcLuRb7LNT5.jpg', label: 'DOGS', imageStyle: { width: '140%', height: '140%', maxWidth: 'none', objectPosition: '55% top', marginLeft: '-20%', marginTop: '-10%' } },
];
