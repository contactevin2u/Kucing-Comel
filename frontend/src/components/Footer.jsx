      ...
      <div className="container">
        <div className="footer-grid">
          ...
          <div className="footer-section" style={{ paddingTop: '45px' }}>
            ...
            <a href="tel:+6001128799638" style={{ display: 'flex', alignItems: 'center', gap: '8px' }}><Phone size={16} strokeWidth={1.5} style={{ marginTop: '-4px' }} /> 01128799638</a>
            <a href="https://maps.google.com/?q=1,+Jalan+Perusahaan+4,+Kawasan+Industri+Batu+Caves,+68100+Batu+Caves,+Selangor" target="_blank" rel="noopener noreferrer" className="footer-address-link" style={{ display: 'flex', alignItems: 'flex-start' }}><MapPin size={14} strokeWidth={1.5} className="footer-mappin" style={{ flexShrink: 0, marginTop: '3px', marginRight: '4px' }} /> 1, Jalan Perusahaan 4, Kawasan Industri Batu Caves, 68100 Batu Caves, Selangor</a>
          </div>
